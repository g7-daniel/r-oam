...
import { Waves, Building, Utensils, Moon, Mountain, Gem, Trees, ShoppingBag, Landmark, Heart, Clock, MapPin, Plus, Check, MessageCircle } from 'lucide-react';
...
export default function Step6Experiences() {
  const {
    destination,
    budget,
    tripType,
  ...
  const spentOnExperiences = selectedExperiences.reduce((sum, exp) => sum + exp.price, 0);
  ...
  useEffect(() => {
    ...
    fetchExperiences();
  }, [destination, tripType, experiencesBudget, selectedCategory]);
    ...
    const baseExperiences: Experience[] = [
      {
        ...
        sentiment: {
          ...
          mentionCount: 1234,
          topComments: [
            { text: 'The skip-the-line access is worth every penny, especially during peak season', subreddit: 'travel', score: 567, date: '2024-01-15' },
          ],
          subreddits: ['travel', 'paris'],
        },
        tips: ['Book sunset time slot for best photos', 'Bring a jacket - it\'s windy at the top'],
      },
      {
        id: '2',
        name: 'Montmartre Food & Wine Tour',
        category: 'food_tours',
        description: 'Explore the culinary delights of Montmartre with tastings at local bakeries, cheese shops, and wine bars.',
        ...
        sentiment: {
          ...
          mentionCount: 456,
          topComments: [
            { text: 'Best food tour I\'ve ever taken! The guide knew all the hidden local spots', subreddit: 'foodtravel', score: 234, date: '2024-01-20' },
          ],
          subreddits: ['travel', 'foodtravel'],
        },
        tips: ['Come hungry!', 'Wear comfortable walking shoes'],
      },
      {
        id: '3',
        name: 'Louvre Museum Guided Tour',
        category: 'museums',
        description: 'See the Mona Lisa and other masterpieces with an expert art historian as your guide.',
        ...
        sentiment: {
          ...
          mentionCount: 2100,
          topComments: [
            { text: 'A guide is absolutely essential for the Louvre - it\'s massive and overwhelming otherwise', subreddit: 'travel', score: 890, date: '2024-01-25' },
          ],
          subreddits: ['travel', 'museums'],
        },
        tips: ['Book early morning slot to avoid crowds', 'The Louvre is closed on Tuesdays'],
      },
      {
        id: '4',
        name: 'Seine River Dinner Cruise',
        category: 'nightlife',
        description: 'Romantic evening cruise along the Seine with a gourmet French dinner and live music.',
        ...
        sentiment: {
          ...
          mentionCount: 678,
          topComments: [
            { text: 'Perfect for a special occasion! The views of illuminated Paris are magical', subreddit: 'travel', score: 345, date: '2024-02-01' },
          ],
          subreddits: ['travel', 'romantictravels'],
        },
        tips: ['Request a window table when booking', 'Dress smart casual'],
      },
      {
        id: '5',
        name: 'Versailles Palace Day Trip',
        category: 'day_trips',
        description: 'Full-day excursion to the magnificent Palace of Versailles with skip-the-line access.',
        ...
        sentiment: {
          ...
          mentionCount: 3456,
          topComments: [
            { text: 'An absolute must-do from Paris. The gardens alone are worth the trip!', subreddit: 'travel', score: 1234, date: '2024-01-10' },
          ],
          subreddits: ['travel', 'paris'],
        },
        tips: ['Visit on a weekday to avoid the crowds', 'The gardens are free on Tuesdays in winter'],
      },
      {
        id: '6',
        name: 'Hidden Speakeasy Bar Tour',
        category: 'hidden_gems',
        description: 'Discover Paris\'s secret cocktail bars and speakeasies with a local mixologist.',
        ...
        sentiment: {
          ...
          mentionCount: 123,
          topComments: [
            { text: 'This tour showed us places we never would have found on our own!', subreddit: 'travel', score: 89, date: '2024-02-05' },
          ],
          subreddits: ['travel', 'cocktails'],
        },
        tips: ['21+ only', 'The locations are kept secret until the tour starts'],
      },
    ];
  ...
  const isSelected = (experienceId: string) =>
    selectedExperiences.some((e) => e.id === experienceId);
