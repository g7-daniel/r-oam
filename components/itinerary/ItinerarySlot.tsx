  ...
  return (
    <div
      className={clsx(
        ...
        getTypeStyles(),
        isDragging && 'shadow-lg ring-2 ring-sky-500 opacity-90'
      )}
    >
      {/* Time Column */}
      ...
      {item.type === 'experience' && dragHandleProps && (
        <div
          {...dragHandleProps}
          className="flex-shrink-0 flex items-center cursor-grab active:cursor-grabbing text-slate-400 hover:text-slate-600"
        >
